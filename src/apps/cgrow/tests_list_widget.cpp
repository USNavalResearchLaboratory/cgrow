...
tests_list_widget::tests_list_widget( QWidget *parent )
    : QWidget( parent )
{
    list = new QListWidget;
    connect( list, SIGNAL( currentRowChanged(int) ),
             this, SIGNAL( current_row_changed(int) )  );
...
{
    testDataItemDialog dialog ( ++current_test_number );
...
void tests_list_widget::remove_test_series_item()
{
    ...
    int ret = QMessageBox::warning(this, tr("HS"),
