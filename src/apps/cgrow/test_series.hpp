...
public:
  ...
  QIcon generate_scatter_icon( ) const;

  void read( const QJsonObject& json );

  void write( QJsonObject& json ) const;

  static QCPScatterStyle::ScatterShape indexToScatterShape( int index );

  static int ScatterShapeToIndex( QCPScatterStyle::ScatterShape ss );

  static QCPScatterStyle::ScatterShape stringToScatterShape( const QString& shape_string );

  static QString ScatterShapeToString( QCPScatterStyle::ScatterShape ss );

private:
  QString id_ = "Crack Growth Data";
};
